...
export class Migration1740080315935 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "admins" ("id" text NOT NULL, "password" text NOT NULL, "email" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "memberId" text, CONSTRAINT "UQ_e3b38270c97a854c48d2e80874e" UNIQUE ("id"), CONSTRAINT "UQ_051db7d37d478a69a7432df1479" UNIQUE ("email"), CONSTRAINT "REL_b455a2a08052498484e856af7c" UNIQUE ("memberId"), CONSTRAINT "PK_e3b38270c97a854c48d2e80874e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "admins" ADD CONSTRAINT "FK_b455a2a08052498484e856af7c1" FOREIGN KEY ("memberId") REFERENCES "members"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "admins" DROP CONSTRAINT "FK_b455a2a08052498484e856af7c1"`);
