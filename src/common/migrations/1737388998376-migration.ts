...
export class Migration1737388998376 implements MigrationInterface {
    name = 'Migration1737388998376'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "admins" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "password" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e3b38270c97a854c48d2e80874e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "members" ("id" text NOT NULL, "firstName" text NOT NULL, "lastName" text NOT NULL, "gender" "public"."members_gender_enum" NOT NULL DEFAULT 'male', "phone" text, "birthdate" text, "email" text, "country" text, "city" text, "location" text, "zone" text, "address" text, "howTheyArrived" text, "baptizedAt" TIMESTAMP, "baptizedChurch" text, "civilStatus" "public"."members_civilstatus_enum" NOT NULL DEFAULT 'single', "weddingAt" TIMESTAMP, "firstVisitAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "spouse_id" text, "adminId" uuid, "memberStatusId" uuid, CONSTRAINT "UQ_28b53062261b996d9c99fa12404" UNIQUE ("id"), CONSTRAINT "UQ_2714af51e3f7dd42cf66eeb08d6" UNIQUE ("email"), CONSTRAINT "REL_cd342ec38ad3d15fc3955532df" UNIQUE ("spouse_id"), CONSTRAINT "REL_476e9f5d3da8cdba45efced39a" UNIQUE ("adminId"), CONSTRAINT "PK_28b53062261b996d9c99fa12404" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "access" ADD CONSTRAINT "FK_e649ad2d43fb04bb4265d5e40bd" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "members" ADD CONSTRAINT "FK_476e9f5d3da8cdba45efced39a4" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "members" DROP CONSTRAINT "FK_476e9f5d3da8cdba45efced39a4"`);
        ...
        await queryRunner.query(`ALTER TABLE "access" DROP CONSTRAINT "FK_e649ad2d43fb04bb4265d5e40bd"`);
