...
export class Migration1740015113309 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."members_gender_enum" AS ENUM('female', 'male')`);
        await queryRunner.query(`CREATE TYPE "public"."members_civilstatus_enum" AS ENUM('married', 'single', 'widower', 'divorced')`);
